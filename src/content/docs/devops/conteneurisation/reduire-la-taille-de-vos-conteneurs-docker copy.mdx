...
⚠️ Contrairement à l’exemple précédent dans la section "Faites le ménage", ici les commandes `RUN` sont combinées pour minimiser le nombre de couches. C’est la meilleure pratique pour une image optimisée.
</Aside>
